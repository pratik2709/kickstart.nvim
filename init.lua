...
require('lazy').setup({
  ...
  --spec = { { import = 'lua.custom.plugins.copilot-chat' } },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      end, { desc = '[S]earch [T]heme (live preview)' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      -- Enable treesitter-based syntax highlighting for all filetypes
  ...
  },
  {
    ...
    version = '*',
    keys = {
      { '<leader>td', '<cmd>ToggleTerm size=10 direction=horizontal<cr>', desc = 'Open a horizontal terminal at the Desktop directory' },
    },
    opts = {
